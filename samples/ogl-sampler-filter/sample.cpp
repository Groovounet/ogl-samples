...
void sample::render()
{
	...
	for(std::size_t Index = 0; Index < viewport::MAX; ++Index)
	{
		...
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, this->MinFilter[Index]);
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, this->MagFilter[Index]);
...
bool sample::initTexture2D()
{
	...
	this->MinFilter[viewport::V00] = GL_NEAREST;
	this->MinFilter[viewport::V10] = GL_LINEAR;
	this->MinFilter[viewport::V11] = GL_LINEAR_MIPMAP_NEAREST;
	this->MinFilter[viewport::V01] = GL_LINEAR_MIPMAP_LINEAR;

	this->MagFilter[viewport::V00] = GL_NEAREST;
	this->MagFilter[viewport::V10] = GL_LINEAR;
	this->MagFilter[viewport::V11] = GL_LINEAR;
	this->MagFilter[viewport::V01] = GL_LINEAR;
