...
namespace
{
	...
	std::string const SAMPLE_VERTEX_SHADER(glf::DATA_DIRECTORY + "400/tess-struct.vert");
	std::string const SAMPLE_CONTROL_SHADER(glf::DATA_DIRECTORY + "400/tess-struct.cont");
