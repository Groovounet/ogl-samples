...
namespace
{
	std::string const SAMPLE_NAME = "OpenGL Error sampler offset";
	...
	{
		glf::DATA_DIRECTORY + "330/error-sampler-offset.frag",
		glf::DATA_DIRECTORY + "330/sampler-bicubic.frag",
	};
