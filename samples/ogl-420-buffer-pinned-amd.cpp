...
namespace
{
	std::string const SAMPLE_NAME = "OpenGL Pinned Memory";
	std::string const VERT_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-420/buffer-pinned-amd.vert");
	std::string const FRAG_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-420/buffer-pinned-amd.frag");
