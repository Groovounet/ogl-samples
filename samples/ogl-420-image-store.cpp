...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE_SAVE(glf::DATA_DIRECTORY + "420/image-store-write.vert");
	std::string const FRAG_SHADER_SOURCE_SAVE(glf::DATA_DIRECTORY + "420/image-store-write.frag");
	std::string const VERT_SHADER_SOURCE_READ(glf::DATA_DIRECTORY + "420/image-store-read.vert");
	std::string const FRAG_SHADER_SOURCE_READ(glf::DATA_DIRECTORY + "420/image-store-read.frag");
