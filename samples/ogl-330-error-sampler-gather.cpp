...
// This sample is design to through an OpenGL error

#include <glf/glf.hpp>

namespace
{
	std::string const SAMPLE_NAME = "OpenGL Error Gather";
	std::string const VERTEX_SHADER_SOURCE(glf::DATA_DIRECTORY + "330/sampler.vert");
	std::string const FRAGMENT_SHADER_SOURCE(glf::DATA_DIRECTORY + "330/error-sampler-gather.frag");
