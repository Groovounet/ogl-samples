...
namespace
{
	...
	std::string const VERTEX_SHADER_SOURCE(glf::DATA_DIRECTORY + "410/unified-gtc.vert");
	std::string const FRAGMENT_SHADER_SOURCE(glf::DATA_DIRECTORY + "410/unified-gtc.frag");
...
bool initTexture2D()
{
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST); // AMD Bug 10.10c
