...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-410/primitive-instancing.vert");
	std::string const GEOM_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-410/primitive-instancing.geom");
	std::string const FRAG_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-410/primitive-instancing.frag");
