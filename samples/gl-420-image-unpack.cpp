...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-420/image-unpack.vert");
	std::string const FRAG_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-420/image-unpack.frag");
