...
namespace
{
	...
	std::string const SAMPLE_VERT_SHADER(glf::DATA_DIRECTORY + "420/matching-array.vert");
	std::string const SAMPLE_CONT_SHADER(glf::DATA_DIRECTORY + "420/matching-array.cont");
	std::string const SAMPLE_EVAL_SHADER(glf::DATA_DIRECTORY + "420/matching-array.eval");
	std::string const SAMPLE_GEOM_SHADER(glf::DATA_DIRECTORY + "420/matching-array.geom");
	std::string const SAMPLE_FRAG_SHADER(glf::DATA_DIRECTORY + "420/matching-array.frag");
