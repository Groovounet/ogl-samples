...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE1(glf::DATA_DIRECTORY + "420/layer.vert");
	std::string const GEOM_SHADER_SOURCE1(glf::DATA_DIRECTORY + "420/layer.geom");
	std::string const FRAG_SHADER_SOURCE1(glf::DATA_DIRECTORY + "420/layer.frag");
	std::string const VERT_SHADER_SOURCE2(glf::DATA_DIRECTORY + "420/viewport.vert");
	std::string const GEOM_SHADER_SOURCE2(glf::DATA_DIRECTORY + "420/viewport.geom");
	std::string const FRAG_SHADER_SOURCE2(glf::DATA_DIRECTORY + "420/viewport.frag");
