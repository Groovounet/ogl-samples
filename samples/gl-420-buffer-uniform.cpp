...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-420/buffer-uniform.vert");
	std::string const FRAG_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-420/buffer-uniform.frag");
