...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-330/point-sprite.vert");
	std::string const FRAG_SHADER_SOURCE(glf::DATA_DIRECTORY + "ogl-330/point-sprite.frag");
