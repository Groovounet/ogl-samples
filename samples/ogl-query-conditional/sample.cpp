...
void sample::render()
{
	...
	glBeginQuery(GL_ANY_SAMPLES_PASSED, this->QueryName);
	...
	glBeginConditionalRender(this->QueryName, GL_QUERY_WAIT);
		glDrawArrays(GL_TRIANGLES, 0, VertexCount);
...
bool sample::initQuery()
{
	...
	return glf::checkError("sample::initQuery");
}
...
bool sample::initProgram()
{
	...
	if(Validated)
	{
		...
		this->UniformColor = glGetUniformLocation(this->ProgramName, "Diffuse");
	}
