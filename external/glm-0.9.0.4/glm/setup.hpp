...
#define GLM_LANGUAGE_CXX_98
#define GLM_LANGUAGE_CXX_03
#define GLM_LANGUAGE_CXX_0X

//! By default:
// #define GLM_LANGUAGE				GLM_LANGUAGE_CXX_98
...
#if(defined(GLM_LANGUAGE))
#	if(GLM_LANGUAGE == GLM_LANGUAGE_CXX_0X)
#		define GLM_STATIC_ASSERT(x) static_assert(x)
